...
WRAP_Imaging_PET_2_pib_suvr_merged <- rbindlist(lapply(tsv_files, read_tsv_file), use.names = TRUE, fill = TRUE)
setcolorder(WRAP_Imaging_PET_2_pib_suvr_merged, c("patient_id", "session_id", "subject_id", "age_at_appointment", "region", "atlas", "dvr", "roi_volume_cc"))

# ─────────────────────────────────────────────────────────────
# Es guarda el fitxer
output_file <- "path/WRAP_Imaging_PET_2_pib_suvr_merged.csv"
write.csv(WRAP_Imaging_PET_2_pib_suvr_merged, output_file, row.names = FALSE)